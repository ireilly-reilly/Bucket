...
### The following are instructions to get the basic Bucket FastAPI backend running on your machine. 
...
1. Download the "Bucket" folder from this branch
2. Open the "Bucket" in your IDE and **MAKE SURE** your terminal is in that directory  
